/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f8d1e068d039a041fe48f90f697050a9)
// Runtime types generated with workerd@1.20260616.1 2024-12-30 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	BETTER_AUTH_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* mr-hype-web */;
}
